...
def _glossary() -> None:
    ...
    st.markdown(
        ...
        "число и перевешивает всё остальное. На вкладке «Игроки» группы считаются "
        "по двум частям KDA отдельно — убийства на смерть и помощь на смерть: после "
        "сравнения с ролью они почти не связаны, и в одном числе разные стили сливались.\n"
