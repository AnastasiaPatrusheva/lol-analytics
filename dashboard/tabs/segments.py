...
def outcome_note(source: str) -> str:
    ...
    Группы названы по убийствам и помощи на смерть, а в победах игроки умирают заметно реже.
...
def render(source: str) -> None:
    ...
    top = counts.iloc[0]
    st.success(
        f"Самая большая группа — «{top['archetype']}»: {int(top['players'])} "
        f"{plural(int(top['players']), 'игрок', 'игрока', 'игроков')}, "
