...
|  |  |
|:--|:--|
| ![Обзор](docs/screenshots/01-overview.jpg) | ![Чемпионы](docs/screenshots/02-champions.jpg) |
| **Обзор** — ключевые цифры и авто-инсайты | **Чемпионы** — рейтинг по нижней границе Уилсона, вердикт с поправкой на множественные сравнения |
| ![Предметы](docs/screenshots/03-items.jpg) | ![Архетипы](docs/screenshots/04-segments.jpg) |
| **Предметы** — с явной оговоркой про выживший-байес | **Архетипы** — KMeans по метрикам, нормированным на роль |
...
**5. Осторожность окупается лучше агрессии.**
