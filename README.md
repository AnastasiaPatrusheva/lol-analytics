...
|:--|:--|
| **Winrate** | доля побед |
| **Winrate с поправкой на число игр** | осторожная оценка (нижняя граница интервала Уилсона): 70% на 5 играх ненадёжно, поэтому малая выборка «штрафуется». По ней строим рейтинг, чтобы наверх не всплывали случайные лидеры |
