...
**6. Группа с высоким KDA выигрывает чаще группы с низким.**
После нормировки метрик на среднее по роли игроки делятся на четыре группы. Сегмент с
высоким KDA («Осторожный») выигрывает 54.8% матчей, сегмент с низким («Часто умирает») —
47.1%. Разрыв 7.7 пункта, но стилем его не объяснить. Эти две группы отличаются в основном
по KDA, а KDA и золото сами зависят от исхода: в победах игроки умирают реже (4.3 смерти за матч
против 6.8) и больше зарабатывают (461 золота в минуту против 389), так что разрыв во многом
следствие побед, а не их причина. Кроме того, он
