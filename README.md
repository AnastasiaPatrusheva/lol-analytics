...
**5. Прогноз по составу работает, но слабо, и это проверено.**
Модель «Состав» обучена на всех патчах, кроме последнего, и проверена на 6743 матчах
патча 16.12, которых не видела. Оцениваются обе команды, побеждает та, чья оценка выше,
поэтому базовый уровень строго 50%. Результат: угадано 52.5% матчей, ROC AUC 0.524.
Сигнал настоящий, но небольшой: состав влияет на исход куда меньше, чем мастерство
игроков и вражеская пятёрка, которую модель не видит. Проверка заодно исправила саму
модель: взвешивание по числу игр оказалось худшим вариантом (51.9%), а осторожная
нижняя граница Уилсона занижала прогноз на 3.8 пункта, поэтому вкладка перешла на
точечный winrate с равными весами ролей.
